...
<html>
    ...
    <style>
      .navbar-brand:hover{
        ...
        .body{
          background-image: url({{asset('images/fondo_opt.jpg')}});
  ...
  <div class="container-fluid">
    ...
    <div  class="collapse navbar-collapse" id="navbarSupportedContent" style="color: #fff;">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="/registrarcarros">Vista 2 - Registrar Menu</a></li>
            <li><a class="dropdown-item" href="/consultarcarros">Vista 3 - Consultar Menu</a></li>
      ...
      <form>
       ...
       <h1 style="text-align: center; color: rgb(16, 15, 15); font-size: 30px;">Taller de mecanica</h1> 
        <div class="container">
            @yield('content')
        </div>
    </body>
